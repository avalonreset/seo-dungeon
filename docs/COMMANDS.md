...
All SEO Dungeon commands start with `/seo` followed by a subcommand.
...
3. Delegates to 8 always-on specialist subagents in parallel, plus conditional specialists when credentials or site signals support them
