...
```powershell
irm https://raw.githubusercontent.com/avalonreset/seo-dungeon/main/install.ps1 | iex
```
...
```bash
curl -fsSL https://raw.githubusercontent.com/avalonreset/seo-dungeon/main/uninstall.sh | bash
```
